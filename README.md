...
This repo is a __Community__ level project. It's a community contributed project
that __is not reviewed or supported by CyberArk__. For more detailed information
...
We __strongly__ recommend choosing the version of this project to use from the
...
1. Generate the master key
   ...
   _* __Tip__: Although not mandatory, we prefer to store sensitive data to a
...
1. Fetch the secret
   ...
   _* __TIP__: If the secret is not displayed, try generating the token again.  You have eight minutes between generating the token and fetching the secret with BotApp._

__Congratulations! You are ready to secure your own apps with Conjur.__
...
_Note: This feature is available in Conjur Open Source v1.11.5+_
